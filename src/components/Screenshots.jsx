...
const screenshots = [
  ...
  },
  {
    ...
    caption: 'Proofread, Rewrite, Concise, Friendly, Professional, X Post, LinkedIn Post—each a one-keystroke spell, live today. The Analyst & Coach collection ships next update.',
